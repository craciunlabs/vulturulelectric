    ...
    <section className="py-12 bg-gray-50">
      <div className="container px-4 sm:px-6 md:px-8">
        ...
        <div className="relative rounded-xl overflow-hidden shadow-xl mb-6">
          ...
          {isMobile ? (
            <div className="bg-white p-4 rounded-lg shadow-lg m-3">
              ...
              <div className="border-t border-gray-100 my-2 pt-2">
                <a 
                  ...
                  className="inline-flex w-full justify-center items-center p-2 font-medium text-white bg-vultur-red rounded-lg hover:bg-red-700 transition-colors"
                >
